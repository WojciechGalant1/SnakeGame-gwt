...
Control the snake using the arrow keys on the keyboard, collecting food and avoiding collisions.
Play until the snake collides with itself or the walls.
After the game ends, you can enter your nickname and save your score to the database by clicking the "Add" button.
